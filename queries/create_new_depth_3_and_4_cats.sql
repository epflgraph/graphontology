...
INSERT INTO Edges_N_Category_N_Concept_T_AnchorPage (`from_id`, `to_id`)
VALUES
...
INSERT INTO Edges_N_Category_N_Category_T_ChildToParent (`from_id`, `to_id`)
VALUES
...
DELETE FROM Edges_N_ConceptsCluster_N_Concept_T_ParentToChild
WHERE to_id='23204';
